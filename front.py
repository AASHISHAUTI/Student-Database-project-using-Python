...
def search_command():
    list1.delete(0,END)
    for row in back.search(name_text.get(),emailid_text.get(),phone_number_text.get(),collegename_text.get(),eventname_text.get(),participationmode_text.get(),amount_text.get()):
        list1.insert(END,row)

def add_command():
    back.insert(name_text.get(),emailid_text.get(),phone_number_text.get(),collegename_text.get(),eventname_text.get(),participationmode_text.get(),amount_text.get())
    list1.delete(0,END)
    list1.insert(END,(name_text.get(),emailid_text.get(),phone_number_text.get(),collegename_text.get(),eventname_text.get(),participationmode_text.get(),amount_text.get()))

def delete_command():
    back.delete(selected_tuple[0])

def update_command():
    back.update(selected_tuple[0],name_text.get(),emailid_text.get(),phone_number_text.get(),collegename_text.get(),eventname_text.get(),participationmode_text.get(),amount_text.get())
...
entry5=Entry(window,textvariable=eventname_text)
